...
int main(void)
{
	...
	validTest("r2 to plane1", intersectPlane(&r, &dummyInter, plane1), false); //was false but should be true
	validTest("r2 to plane2", intersectPlane(&r, &dummyInter, plane2), false); //was false but should be true
