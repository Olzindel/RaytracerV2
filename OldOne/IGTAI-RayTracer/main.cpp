...
Scene *initScene4()
{
	...
	mat.diffuseColor = color3(.1f);
	mat.specularColor = color3(.71f);
	mat.IOR = 1.6;
	mat.roughness = 0.001f;
	addObject(scene, initTriangle(point3(1, -.05, 0), point3(0, 0.1, 0), point3(1.3, 0., 2.6), mat));

	mat.diffuseColor = color3(.4f);
	mat.specularColor = color3(.71f);
	mat.IOR = 1.6;
	mat.roughness = 0.001f;
	addObject(scene, initTriangle(point3(1, -.05, 0), point3(.77f, .5f, 2.f), point3(1.3, 0., 2.6), mat));

	mat.diffuseColor = color3(.3f);
	mat.specularColor = color3(.71f);
	mat.IOR = 1.6;
	mat.roughness = 0.001f;
	addObject(scene, initTriangle(point3(.77f, .5f, 2.f), point3(0, 0.1, 0), point3(1.3, 0., 2.6), mat));

	mat.diffuseColor = color3(0.75f, 0.14f, .0f);
	mat.specularColor = color3(.71f);
	mat.IOR = 1.6;
	mat.roughness = 0.001f;
	addObject(scene, initTriangle(point3(1, -.05, 0), point3(0, 0.1, 0), point3(.77f, .5f, 2.f), mat));
